                              ...
                              `}
                                                                    >
                                                                        ...
                                                                        <td className="p-2 text-center">
                                                                            {d.checked ? (
                                                                                <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-green-300 text-green-600 text-xs font-bold">
                                                                                    ✓
                                                                                </span>
                                                                            ) : (
                                                                                <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-red-300 text-red-500 text-xs font-bold">
                                                                                    –
                                                                                </span>
                                                                            )}
                                                                        </td>
